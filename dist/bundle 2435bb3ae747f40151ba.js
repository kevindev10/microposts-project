...
var EasyHTTP = /*#__PURE__*/function () {
  ...
  _createClass(EasyHTTP, [{
    key: "get",
    value: // Make an HTTP GET Request 
    function () {
...
var UI = /*#__PURE__*/function () {
  function UI() {
    ...
    this.idInput = document.querySelector('#id'); // this.postSubmit = document.querySelector('.post-submit');
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n\r\n.delete {\r\n  color: red;\r\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":";;AAEA;EACE,UAAU;AACZ","sourcesContent":["\r\n\r\n.delete {\r\n  color: red;\r\n}"],"sourceRoot":""}]);
// Exports
...
document.querySelector('.post-submit').addEventListener('click', submitPost); // Get posts from api

function getPosts(e) {
  _http__WEBPACK_IMPORTED_MODULE_1__.http.get('http://localhost:3001/posts').then(function (data) {
    _ui__WEBPACK_IMPORTED_MODULE_2__.ui.showPosts(data);
  })["catch"](function (err) {
...
function submitPost(e) {
  ...
  if (title !== '' && body !== '') {
    ...
    _http__WEBPACK_IMPORTED_MODULE_1__.http.post('http://localhost:3001/posts', data).then(function (data) {
      _ui__WEBPACK_IMPORTED_MODULE_2__.ui.showAlert('Post added', 'alert alert-success');
      _ui__WEBPACK_IMPORTED_MODULE_2__.ui.clearFields();
      getPosts();
    })["catch"](function (err) {
      return err;
    });
...
/******/ })()
;
//# sourceMappingURL=bundle 2435bb3ae747f40151ba.js.map